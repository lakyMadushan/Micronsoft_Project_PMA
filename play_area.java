 ...
 * @author DELL
 */
public class play_area extends javax.swing.JFrame {
    ...
    public void idload() {
        try {
            ResultSet rs = DB.search("select id from play_a order by id desc");
            if (rs.next()) {
    ...
    public void tableload() {
        ...
        dtm.setRowCount(0);
        try {
            ResultSet rs = DB.search("select * from play_a ");
            while (rs.next()) {
            ...
            if (jTextField2.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            DB.iud("delete from play_a where id = '" + jTextField1.getText() + "' ");
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            ...
                            DB.iud("update play_a set e_fee = '" + jTextField2.getText() + "' ");
                            DB.iud("update play_a set ex_fee = '" + jTextField3.getText() + "' ");
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        ...
                        DB.iud("update play_a set e_fee = '" + jTextField2.getText() + "' where id = '" + jTextField1.getText() + "' ");
                        DB.iud("update play_a set ex_fee = '" + jTextField3.getText() + "' where id = '" + jTextField1.getText() + "' ");
                        JOptionPane.showMessageDialog(this, "Update Successfully!", "DONE", JOptionPane.INFORMATION_MESSAGE, icon);
...
//            } else {
            ...
            if (jTable1.getRowCount() == i) {
                ...
                try {
                    DB.iud("insert into play_a (id,e_fee,ex_fee) "
...
//        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(play_area.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
