...
public class kids extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("* You can search child using Parent Name Or Phone");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Perent Reg", "Perent Name", "phone", "Child"
            }
        ) {
        ...
        if (jTextField2.getText().equals("") && jTextField3.getText().equals("")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("admin123")) {
                    try {
                        DB.iud("delete from kids where id = '" + jTextField1.getText() + "' ");
    ...
    private void jTextField3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField3KeyReleased
        try {
            ResultSet rs = DB.search("select * from parent where name like '%" + jTextField3.getText() + "%' order by id asc ");
            Vector v = new Vector();
            while (rs.next()) {
                v.add(rs.getString("s_g_id") + "##" + rs.getString("name") + "-" + rs.getString("phone") + "-" + rs.getString("nic"));
            }
    ...
    private void jTextField4KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField4KeyReleased
        try {
            ResultSet rs = DB.search("select * from parent where phone like '%" + jTextField4.getText() + "%' order by id asc ");
            Vector v = new Vector();
            while (rs.next()) {
                v.add(rs.getString("s_g_id") + "##" + rs.getString("name") + "-" + rs.getString("phone") + "-" + rs.getString("nic"));
            }
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        ...
        if (selectedValue != null) {
            ...
            // search allready childs using parent name phone
            try {
                DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
                dtm.setRowCount(0);
                ResultSet rs = DB.search("select * from kids where p_g_id = '" + parts[0] + "'  ");
                while (rs.next()) {
                    Vector<Object> v = new Vector<>();
                    v.add(rs.getString("id"));
                    v.add(rs.getString("p_g_id"));
                    v.add(rs.getString("p_name"));
                    v.add(rs.getString("p_phone"));
                    v.add(rs.getString("kid_name"));
    ...
    private void jButton1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_RIGHT) {
            ...
            // save
            if (jTextField2.getText().equals("") && jTextField5.getText().equals("")) {
                ...
                try {
                    ...
                    for (int i = 0; i < dtm.getRowCount(); i++) {
                        ...
                        String p_name = dtm.getValueAt(i, 2).toString();
                        String p_phone = dtm.getValueAt(i, 3).toString();
                        String kid = dtm.getValueAt(i, 4).toString();

                        DB.iud("insert into kids (id,p_g_id,p_name,p_phone,kid_name) "
                                + "values ( '" + id + "', '" + p_id + "','" + p_name + "','" + p_phone + "','" + kid + "' )");
            ...
            try {
                if (jTextField2.getText().equals("") && jTextField3.getText().equals("")) {
                    ...
                    if (option == JOptionPane.OK_OPTION) {
                        String password = new String(passwordField.getPassword());
                        if (password.equals("admin123")) {
                            DB.iud("update kids set "
                                    + " p_g_id = '" + jTextField2.getText() + "',p_name = '" + jTextField3.getText() + "',"
                                    + " p_phone = '" + jTextField4.getText() + "',kid_name = '" + jTextField5.getText() + "'"
        ...
        if (jTextField2.getText().equals("") && jTextField5.getText().equals("")) {
            ...
            try {
                ...
                for (int i = 0; i < dtm.getRowCount(); i++) {
                    ...
                    DB.iud("insert into kids (p_g_id,p_name,p_phone,kid_name) "
                            + "values ( '" + p_id + "','" + p_name + "','" + p_phone + "','" + kid + "' )");
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                if (jTable1.getSelectedRow() != -1) {
                    ...
                    String p_reg = dtm.getValueAt(jTable1.getSelectedRow(), 1).toString();
                    String p_name = dtm.getValueAt(jTable1.getSelectedRow(), 2).toString();
                    String p_phone = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
                    String child = dtm.getValueAt(jTable1.getSelectedRow(), 4).toString();

                    jTextField1.setText(id);
                    jTextField2.setText(p_reg);
                    jTextField3.setText(p_name);
                    jTextField4.setText(p_phone);
                    jTextField5.setText(child);
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from kids order by id DESC");
            if (rs.next()) {
    ...
    private void tableLoad() {
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from kids order by id DESC");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
                v.add(rs.getString("id"));
                v.add(rs.getString("p_g_id"));
